        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-linear-to-br from-indigo-600 via-violet-600 to-purple-600 flex items-center justify-center text-white shadow-md shadow-indigo-500/20 ring-1 ring-indigo-500/30">
                <Sparkles className="w-5 h-5" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <h1 className="text-base sm:text-lg font-bold text-slate-900 tracking-tight flex items-center gap-1.5">
                    <span className="bg-linear-to-r from-indigo-700 to-violet-700 bg-clip-text text-transparent font-extrabold">
                      guruAI
                    </span>
                    <span className="hidden sm:inline-flex text-[11px] font-semibold px-2.5 py-0.5 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200/60">
                      Learn AI from Scratch
                    </span>
                  </h1>
                </div>
                <p className="text-xs text-slate-500 hidden sm:block">
                  Zero jargon • Everyday analogies for parents, beginners & curious minds
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-1 bg-slate-100/90 p-1 rounded-xl border border-slate-200/80">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                isLearnMode
                  ? 'bg-white text-slate-900 shadow-xs font-bold text-indigo-950'
                  : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              <BookOpen className="w-3.5 h-3.5 text-indigo-600" />
              <span>Learn AI 101</span>
            </button>
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                isSandboxMode
                  ? 'bg-white text-slate-900 shadow-xs font-bold ring-1 ring-amber-500/40 text-amber-950'
                  : 'text-slate-600 hover:text-slate-900'
              }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                isAnalogyMode
                  ? 'bg-white text-slate-900 shadow-xs font-bold text-violet-950'
                  : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              <Lightbulb className="w-3.5 h-3.5 text-violet-600" />
              <span>AI Analogies</span>
            </button>
            ...
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                isQuizMode
                  ? 'bg-white text-slate-900 shadow-xs font-bold text-emerald-950'
                  : 'text-slate-600 hover:text-slate-900'
              }`}
            >
              <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
              <span>AI Quiz & Myths</span>
            </button>
          </div>
          ...
          <div className="hidden md:flex items-center gap-2">
            <select
              ...
              className="text-xs bg-white border border-slate-200 rounded-lg px-2.5 py-1.5 text-slate-700 font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 cursor-pointer shadow-2xs"
            >
            ...
            <button
              ...
              onClick={() => setAudioEnabled(!audioEnabled)}
              className={`p-2 rounded-lg border text-xs font-medium transition-colors flex items-center gap-1.5 shadow-2xs ${
                audioEnabled
                  ? 'bg-indigo-50 border-indigo-200 text-indigo-700'
